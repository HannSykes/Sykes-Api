...
loghandler = {
    notparam: {
        ...
        creator: `${creator}`,
        code: 406,
        thumb: 'https://i.top4top.io/p_2142w9ser1.png',
...
const listkey = ["ilhansykes712", "ilhanecha"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'ilhansykes712') return res.sendFile(__path + '/views/eror.html')
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'ilhansykes712')  return res.sendFile(__path + '/views/eror.html')
...
router.get('/randomporn', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'ilhansykes712')  return res.sendFile(__path + '/views/eror.html')
       fetch(encodeURI(`https://raw.githubusercontent.com/HannSykes/Baileys/master/src/WAConnection/Hannsz.json`))
        .then(response => response.json())
        .then(data => {
        var ilhansykes = data;
...
router.get('/randomquote', async (req, res, next) => {
	...
	if(apikeyInput != 'ilhansykes712') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/IlhanSykes/database-api/main/fun/quote.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/caklontong', async (req, res, next) => {
	...
	if(apikeyInput != 'ilhansykes712') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/IlhanSykes/database-api/main/fun/caklontong.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakgambar', async (req, res, next) => {
	...
	if(apikeyInput != 'ilhansykes712') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/IlhanSykes/database-api/main/fun/tebakgambar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/stikerwa', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'ilhansykes712')  return res.sendFile(__path + '/views/eror.html')
       fetch(encodeURI(`https://velgrynd.herokuapp.com/api/sticker?query=${q}`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/tiktokk', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'ilhansykes712')  return res.sendFile(__path + '/views/eror.html')
       fetch(encodeURI(`https://hadi-api.herokuapp.com/api/tiktok?url=${q}`))
        .then(response => response.json())
        .then(data => {
        var result = data.result;
             res.json({
...
router.get('/darkjokes', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'ilhansykes712')  return res.json(invalidKeynya)
       fetch(encodeURI(`https://raw.githubusercontent.com/IlhanSykes/database-api/main/meme/darkjokes.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cekapikeyy', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'ilhansykes712') return res.json(loghandler.notparam)
    if (!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
