...
const listkey = ["hannsykes", "ilhansykes"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'hannsykes') return res.sendFile(__path + '/views/eror.html')
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'hannsykes')  return res.sendFile(__path + '/views/eror.html')
...
router.get('/darkjokes', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'hannsykes')  return res.json(invalidKeynya)
